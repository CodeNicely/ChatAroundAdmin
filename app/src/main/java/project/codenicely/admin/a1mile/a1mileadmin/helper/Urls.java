...
public class Urls {
    ...
    public static final String SUB_URL_ADMIN_RESTROOM_LIST = "AdminRestroomList";
    ...
    public static final String SUB_URL_ADMIN_UPDATE_RESTROOM_STATUS ="UpdateRestroomStatus" ;
